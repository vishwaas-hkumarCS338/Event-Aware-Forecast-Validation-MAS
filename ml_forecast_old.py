# ml_forecast.py (original raw quantile forecaster)
import pickle
...
# These are the feature columns used by the original model
...
def _latest_context(product: str, year: int, month: int) -> pd.DataFrame | None:
    ...
    if has12:
        # Take the 12th-from-last value if available
...
def predict_product_quantiles(product: str, year: int, month: int) -> dict:
    """Used by validation_agent in the live API."""
